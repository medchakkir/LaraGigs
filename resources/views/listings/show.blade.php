    ...
    <div class="mx-auto max-w-4xl px-4 py-8">
        ...
        <x-card>
            <div class="mb-8 flex flex-col gap-6 md:flex-row">
                <img
                    class="h-32 w-32 rounded-xl bg-gray-50 object-contain shadow-sm dark:bg-slate-700"
            ...
            <div class="border-t border-gray-200 pt-8 dark:border-slate-700">
                ...
                <div class="prose prose-gray dark:prose-invert max-w-none">
                    <p
                        class="mb-6 leading-relaxed text-gray-700 dark:text-gray-300"
                    >
                        {{ $listing->description }}
                    </p>
                </div>
        ...
        <x-card class="mt-4 flex space-x-6 p-2">
            ...
            <form method="POST" action="/listings/{{ $listing->id }}">
                ...
                <button
                    type="submit"
                    class="flex items-center gap-2 text-red-600 transition hover:text-red-500"
                >
