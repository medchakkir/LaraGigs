...
<html lang="en">
    ...
    >
                    ...
                    <ul class="flex items-center gap-3 text-sm font-medium">
                        <li>
                            ...
                            >
                                ...
                                <i
                                    class="fa-solid fa-moon hidden dark:inline"
                                ></i>
        ...
        <footer
            class="border-t border-gray-200 bg-white dark:border-slate-700 dark:bg-slate-800"
        >
            <div
                class="mx-auto flex h-20 max-w-6xl items-center justify-center px-4"
            >
