<form action="/" class="relative z-20 -mt-8" role="search">
    <div class="mx-auto max-w-3xl px-4">
        <div
            ...
            <label for="search-input" class="sr-only">Search Laravel Jobs</label>
            <input type="text" id="search-input" name="search" value="{{ request('search') }}"
                ...
                placeholder="Search for Laravel jobs, companies, or locations..."
                aria-label="Search for Laravel jobs and projects" autocomplete="off" />
